...
// async await example
// add async keyword - to a function so it returns a resolved promise
// throw new Error() - to returns a rejected promise
...
getStatusAlt(1).then((name) => {
    // throw new Error() - to trigger the reject method
    console.log(name);
});
